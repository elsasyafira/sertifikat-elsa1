      ...
      <div class="row">
        ...
        <div class="card">
            <div class="card-body">
              ...
              <p><a href="<?= base_url('event/tambah_event');?>" target="_blank">tambah event </a> <code></code> </p>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="<?= base_url('menu/event/edit_event/' .$evn->event_id) ?>"
                        > edit</a></li>
                        <li><a class="dropdown-item" href="<?= base_url('menu/event/hapus_event/' .$evn->event_id); ?>"
                        > hapus</a></li>
                    </ul>
                </div>
                </div>
